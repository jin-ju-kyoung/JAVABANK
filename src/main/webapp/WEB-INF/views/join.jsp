...
<body>
    <section id="join">
        <form name="f" action="joinSuccess.do" method="post">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
            ...
            <div class="input_box">
                <div class="info_box">
                    ...
                    <label>
                        <input type="text" placeholder="생년월일 ex&#41;2024-10-01" name="userBirth" required>
                    </label>
                    <div class="email_box">
                        <label>
                    ...
                    <div class="tel_box">
                        <label>
                            <input type="text" placeholder="핸드폰번호 ex&#41;010-0000-0000" name="userTel" required>
                        </label>
                ...
                <div class="my_box">
                    <div class="id_box">
                        ...
                        <button class="repeat_btn" type="button" onclick="idCheck()">중복확인</button>
                    </div>
                    <label>
                        <input type="password" placeholder="비밀번호 ex&#41;영문,숫자가 포함된 8글자 이상의 조합" name="userPw" required>
                    </label>
