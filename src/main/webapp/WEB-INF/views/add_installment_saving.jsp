...
<%@ include file="index_top.jsp"%>
    ...
    <section id="add installment_saving" class="content add_bank">
        ...
        <form name="f" action="/addInstallmentSavingOk.do" method="post" onsubmit="return submitForm()">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
            ...
            <div>
                ...
                <div class="">
                    <label>
                        <input type="text" name="monthlyPayment" value="">
                    </label>
                </div>
            </div>
